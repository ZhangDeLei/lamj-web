<template>
  <div class="content">
    <div class="crumb">
      ...
      <el-button type="primary" class="pri-button" @click="showInsertDialog">新增级别</el-button>
    </div>
    ...
    <el-dialog title="新增队伍" :visible.sync="dialogEditShow" width="50%" :modal-append-to-body="false">
      <el-form ref="editForm" :model="editForm" size="mini" :rules="rules" label-width="100px">
        ...
        <el-form-item label="排序">
          <el-input v-model="editForm.sortBy" placeholder="排序"></el-input>
        </el-form-item>
        <el-form-item label="描述">
          <el-input v-model="editForm.comment" type="textarea" placeholder="描述"></el-input>
        </el-form-item>
      </el-form>
...
<script src="../../../assets/js/custom/articleLevel/article-level.js">
</script>

<style scoped>
  @import "../../../assets/css/custom/articleLevel/article-level.css";
</style>
